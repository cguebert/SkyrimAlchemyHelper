...
public:
	...
	QString gameName = "Skyrim";  // Game name (Skyrim, Syrim Special Edition, Skyrim VR)
	QString language = "english"; // When parsing mods, try to use the strings table for this language

	std::map<QString, GameSpecific> gameSpecific;

	bool loadMostRecentSave = true, // If true, always load the most recent save instead of a user chosen one
